...
EDITOR_PYTHON_DIR = REPO_DIR / "layout-editor-electron" / "python"
if str(EDITOR_PYTHON_DIR) not in sys.path:
    sys.path.insert(0, str(EDITOR_PYTHON_DIR))

from editor_can_analysis import summarize_can_records  # noqa: E402
