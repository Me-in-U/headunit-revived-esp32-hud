...
from hud_pi.renderer_elements import RendererElementDrawingMixin
from hud_pi.state import HudState


class DispatchRenderer(RendererElementDrawingMixin):
...
class RendererElementsTest(unittest.TestCase):
    def test_renderer_element_mixin_preserves_action_dispatch_order(self) -> None:
